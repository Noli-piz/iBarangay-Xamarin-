...
namespace iBarangayApp
{
    ...
    public class CustomAdapterRequest : BaseAdapter
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            txtItem.Text = requestArrayList[position].item;
            txtDate.Text = requestArrayList[position].date;
            txtPurpose.Text = requestArrayList[position].purpose;
            txtStatus.Text = requestArrayList[position].status;
